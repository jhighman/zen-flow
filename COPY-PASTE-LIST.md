# Veiflow - A Modern Fullstack Worklfow System for Verification
...
try {
    ...
    from: 'Veriflow <jhighman@gmail.com>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your Veriflow Receipt</Preview>
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to Veriflow, the marketplace for high quality digital
